			...
			<section id="intro">
				<div className="introContent">
					...
					<p className="introPara">
						I am a skilled and passionate web developer (Beginner) based in Kanyakumari, Tamil Nadu, India. Experienced in creating visually appealing and user-friendly websites. Seeking a web development Assistant role or an Internship to gain experience in a web development environment. Whether it&apos;s making user-friendly designs or diving into backend development, I enjoy the challenge. Feel free to drop me a line if you&apos;ve got a cool project or job on the horizon, or if you&apos;re just up for a lively conversation about web development. I&apos;m eager to hear from you!
					</p>
					<hr />
